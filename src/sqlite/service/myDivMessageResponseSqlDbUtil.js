 ...
 */
export const messageKeywordsResponse = () => {
    return new Promise((resolve, reject) => {
        ...
        // 建立连接
        messageKeywordsDb.createTable(`CREATE TABLE IF NOT EXISTS messageKeywords
            (
        ...
        `)
            .then(() => {
                return messageKeywordsResponseDb.createTable(`CREATE TABLE IF NOT EXISTS messageKeywordsResponse
                (
                    id       INTEGER PRIMARY KEY AUTOINCREMENT,
                    sort   TEXT NOT NULL, -- '排序'
            ...
            .finally(() => {
                // 关闭数据库连接
                messageKeywordsDb.close();
                messageKeywordsResponseDb.close();
            });
    });
};
